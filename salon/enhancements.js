...
window.openEventFormV41=function(eid=''){
  ...
  form.onsubmit=function(ev){
    ...
    // V123: normalización inmediata y única.
...
window.openEventFormV44=function(eid=''){
  ...
  // --------------------------------------------------------
  // V123: V44 queda solo como capa visual.
  // NO vuelve a modificar totales ni guarda la reserva.
  // Evita que el total completo termine copiado en staffClientChargeTotal.
  const oldSubmit=form.onsubmit;
  form.onsubmit=function(ev){
    return oldSubmit ? oldSubmit.call(form,ev) : undefined;
  };
